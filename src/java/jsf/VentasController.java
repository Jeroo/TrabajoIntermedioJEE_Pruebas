...
public class VentasController implements Serializable {
    ...
    @EJB
    private beans.VentasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("VentasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("VentasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("VentasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class VentasControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Ventas) {
                ...
                return getStringKey(o.getCodigoventa());
            } else {
